...
| File / dir | What it is |
|---|---|
| `../../docs/specs/simsuite_implementation_specs.md` | Engineering specs for the 8 proposed projects (4 full, 4 condensed) |
| `../../docs/research/compass_artifact_diversity_metrics.md` | Deep-research review: 10 papers + 10 platforms, 7 cross-cutting open problems, 8 novel paper ideas |
