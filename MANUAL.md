...
container deployments (see DEPLOY-AWS.md for persistence).

---

## 9. The `research/` folder

Separate from the product. Contains the APIP paper (`research/apip/`), its FastAPI simulation
(`research/apip_sim/`, launched by `research/run_apip.sh` on **:8100**), conference deadline notes,
and figure generators. Touch this only for the research artifacts, not the tool.

---

## 10. Deployment

Containerized deployment to **AWS ECS** via GitHub Actions is documented in **`DEPLOY-AWS.md`**
