"""Build the Research Paper Workspace slide deck per docs/specs/POWERPOINT_SPEC.md."""
...
OUTPUT = str(REPO_ROOT / "docs" / "research_paper_workspace.pptx")
...
def slide_10_deployment(prs):
    ...
    details = [
        ...
        ("AWS ECS Express Mode",
         "See docs/guides/DEPLOY-AWS.md for full setup.\n"
...
def slide_12_roadmap(prs):
    ...
    links = [
        ("docs/guides/MANUAL.md", "Full user guide + API reference"),
        ("README.md", "Quick-start & architecture overview"),
        ("docs/guides/DEPLOY-AWS.md", "ECS Express deployment guide"),
        ("CRITIQUE_SPEC.md", "Critic design & scoring algorithm"),
        ("sims/apip_sim/", "APIP simulation (port 8100)"),
    ]
