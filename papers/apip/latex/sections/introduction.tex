...
\begin{itemize}
  ...
  \item We demonstrate the mesh disruption problem---where a locally optimal
        new agent degrades peer performance---empirically, framing it through
        Event System Theory and the team membership change literature, and we
        evaluate a scoped-context onboarding protocol as its mitigation.
\end{itemize}
