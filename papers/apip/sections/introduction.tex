...
\begin{itemize}
  ...
  \item We develop a four-category taxonomy of agent failure modes that maps
        onto APIP cause-finding procedures.
  ...
  \item We motivate and illustrate the framework through a hypothetical
        customer service agent deployment scenario.
  \item We identify the mesh disruption problem---where a locally optimal new
        agent degrades peer performance---as a critical open problem, framing it
        through Event System Theory and the team membership change literature.
\end{itemize}
