...
- The **conclusion** still says "It uses Kirkpatrick's model to separate durable recovery from
  superficial improvement." The separation the paper demonstrates comes from the envelope and
  the exit states, not from Kirkpatrick levels. **Unaddressed — this is the sentence to fix if
  D1 is fixed at all.**
