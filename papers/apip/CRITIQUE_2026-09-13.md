...
*Status: **closed in `a907edf`.** The M9 sentence names the tiers — prompt (1), context/tool (2),
model (3) — ahead of Table I, using M10's locus wording, and §IV-C now carries the
`\label{sec:tiers}` it cross-references.*
