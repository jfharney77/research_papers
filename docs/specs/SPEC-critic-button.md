...
- **E2E:** `./scripts/web/start.sh`, open a document, run the Critic tab, confirm per-section gauges + criticisms + de-AI tips render and the provider name is shown; upload a standalone PDF via the ad-hoc panel.
